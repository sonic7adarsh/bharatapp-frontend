...
export default function FloatingCartButton() {
  ...
  return (
    <div className={`fixed bottom-4 right-4 md:bottom-6 md:right-6 z-50 transition-all duration-300 ${
      ...
      <Link
        to="/cart"
        className="flex items-center space-x-2 md:space-x-3 rounded-full shadow-xl bg-indigo-600 text-white px-3 py-2 md:px-4 md:py-3 hover:bg-indigo-700 active:scale-95 transition-all duration-200 touch-manipulation"
      ...
      >
        <div className="relative">
          ...
          <span className="absolute -top-2 -right-2 inline-flex items-center justify-center bg-red-500 text-white font-bold rounded-full h-5 min-w-[20px] px-1 text-xs">
