    ...
    <>
      <div className={`fixed bottom-4 right-4 md:bottom-6 md:right-6 z-50 transition-all duration-300 ${
        ...
        <div className="relative">
          ...
          <span className="absolute -top-2 -right-2 inline-flex items-center justify-center bg-brand-primary text-white font-bold rounded-full h-5 min-w-[20px] px-1 text-xs" aria-live="polite">
